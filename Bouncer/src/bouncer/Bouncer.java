...
public class Bouncer extends AnimationComponent {
    ...
    protected void setClip(Graphics2D g2) {
        ...
        if (mClipShape == null) {
            ...
            mClipShape = gv.getOutline((d.width - (float)bounds.getWidth()) / 2, (d.height + (float)bounds.getHeight()) / 2);
        }
        g2.clip(mClipShape);
    }
    ...
    protected void setStroke(Graphics2D g2) {
        ...
        Stroke stroke = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10, new float[] { 4, 4 }, 0);
        g2.setStroke(stroke);
    }
