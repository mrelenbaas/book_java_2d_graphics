...
public class Sampler extends Frame {
    ...
    public static void main(String[] args) {
        String imageFile = "C:\\Users\\mrele\\Documents\\book_java_2d_graphics\\Sampler\\src\\sampler\\background.jpg";
    ...
    public Sampler(String imageFile) {
        super("Sampler v1.0");
        createOps();
        File someFile = new File(imageFile);
    ...
    private void createTransformations() {
        ...
        mOps.put("Scale .5, .5", new AffineTransformOp(at, rh));
